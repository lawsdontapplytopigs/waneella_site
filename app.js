...
var $author$project$SampleData$posts = _List_fromArray(
	[
		{src: '../../../samples/posts/img_3.gif', title: '12.524345, 45.257297'},
		{src: '../../../samples/posts/img_4.gif', title: 'sick flag waving'},
		{src: '../../../samples/posts/img_2.gif', title: '15.254724 64.374382'}
	]);
var $author$project$Main$init = F3(
	function (flags, url, key) {
		return _Utils_Tuple2(
			{
				contactData: {email: $elm$core$Maybe$Nothing, message: $elm$core$Maybe$Nothing, subject: $elm$core$Maybe$Nothing},
				key: key,
				posts: $author$project$SampleData$posts,
				url: url
			},
					...
					_Utils_update(
						model,
						{
							contactData: {
								...
								subject: $elm$core$Maybe$Just(str)
							}
						}),
					$elm$core$Platform$Cmd$none);
			case 'EmailInput':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							contactData: {
								email: model.contactData.email,
								message: $elm$core$Maybe$Just(str),
								subject: model.contactData.subject
							}
						}),
					$elm$core$Platform$Cmd$none);
	...
	return A2(
		...
		_List_fromArray(
			[
				subjectRoundedBar(
				function () {
					var _v0 = model.contactData.subject;
					if (_v0.$ === 'Nothing') {
						return '';
					} else {
						var str = _v0.a;
				...
				emailRoundedBar(
				function () {
					var _v1 = model.contactData.email;
					if (_v1.$ === 'Nothing') {
						return '';
					} else {
						var str = _v1.a;
				...
				messageField(
				function () {
					var _v2 = model.contactData.message;
					if (_v2.$ === 'Nothing') {
						return '';
					} else {
						var str = _v2.a;
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				{bottom: 0, left: 0, right: 0, top: 64 + 60})
			]),
		_List_fromArray(
			[
	...
	var button = function () {
		...
		return A2(
				...
				]),
			{
				...
				onPress: $elm$core$Maybe$Just($author$project$Msg$NoOp)
			});
	}();
	return A2(
		$mdgriffith$elm_ui$Element$el,
					...
					[
						...
						_List_fromArray(
							[
								...
								{description: 'POG', src: '../../../assets/hr_real_size_fixed.gif'}),
								A2(
								$mdgriffith$elm_ui$Element$column,
								_List_fromArray(
									[
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				A2($elm$core$List$map, $author$project$V$Desktop$Home$littleExpoPost, model.posts)),
				A2(
				$mdgriffith$elm_ui$Element$el,
				_List_fromArray(
					[
